if Rails.env.development?
  ...
  u1.skill_list = User::SKILLS.sample(2+rand(4)).join(', ')
  u1.save

  u2.skill_list = User::SKILLS.sample(2+rand(4)).join(', ')
  u2.save

  u3.skill_list = User::SKILLS.sample(2+rand(4)).join(', ')
  u3.save

  u1.role_list = User::ROLES.sample(1+rand(2)).join(', ')
  u1.save

  u2.role_list = User::ROLES.sample(1+rand(2)).join(', ')
  u2.save

  u3.role_list = User::ROLES.sample(1+rand(2)).join(', ')
  u3.save
